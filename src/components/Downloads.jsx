...
const Downloads = () => {
  const downloadCategories = [
    ...
    },
    {
      ...
      description: "Conference schedule and important dates",
      files: [
        {
          id: 8,
          name: "Conference Schedule 2025",
          file: "/assets/files/Conference_Schedule_2025.pdf",
          type: "PDF",
          size: "1.2 MB",
          description: "Complete conference schedule for ICACS 2025",
        },
        {
          id: 9,
          name: "Keynote Speech Schedule",
          file: "/assets/files/Keynote_Speech_Schedule_2025.pdf",
          type: "PDF",
          size: "0.6 MB",
          description: "Schedule of keynote speeches",
        },
        {
          id: 10,
          name: "Conference Tracks",
          file: "/assets/files/Conference Tracks_30_8_2023.pdf",
          type: "PDF",
          size: "0.9 MB",
          description: "Details about conference tracks",
        },
      ],
    },
    {
      ...
      description: "Participant certificates and course materials",
      files: [
        {
          id: 11,
          name: "Participant Certificates",
          file: "/assets/files/Participants_Certificates.zip",
          type: "ZIP",
          size: "8.5 MB",
          description: "Certificate files for participants",
        },
        {
          id: 12,
          name: "Updated Participation Certificates",
          file: "/assets/files/Updated_Participation Certificates - ICACS 2025 - 10-03-2025.zip",
          type: "ZIP",
          size: "9.2 MB",
          description: "Latest updated participation certificates",
        },
      ],
    },
  ];
